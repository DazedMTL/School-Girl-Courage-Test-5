...
(function () {
  ...
  var pd_HIN_DefaultAll =
    PluginManager.parameters("HideItemNumber")["Default_All"];
  var pd_HIN_ForceDefault =
    PluginManager.parameters("HideItemNumber")["ForceSetDefault"];
  ...
  Window_ItemList.prototype.drawItemName = function (item, x, y, width) {
    if ($gameTemp._pd_HIN_HideItemNum) {
      Window_Base.prototype.drawItemName.call(
        this,
        item,
        x,
        y,
  ...
  var pd_HIN_Window_ItemList_drawItemNumber =
