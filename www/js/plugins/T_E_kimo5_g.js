    ...
    if (command === "Jyotai") {
      ...
      if ($gameVariables.value(160 + eval(args[1]))[0] == 0) {
        ...
        if ($gameVariables.value(160 + eval(args[1]))[2] == 0) {
          ...
          $gameVariables.value(160 + eval(args[1]))[2] == 10 &&
          $gameVariables.value(160 + eval(args[1]))[7] == 0
        ) {
          //利尿---途中放尿した場合は汚れない
        } else if (
          $gameVariables.value(160 + eval(args[1]))[2] == 10 &&
          $gameVariables.value(160 + eval(args[1]))[7] == 1
        ) {
          //利尿---途中放尿なし　失禁
          ...
          $gameVariables.value(160 + eval(args[1]))[2] == 20 &&
          $gameVariables.value(160 + eval(args[1]))[8] == 0
        ) {
          //下剤---途中排便した場合は汚れない
        } else if (
          $gameVariables.value(160 + eval(args[1]))[2] == 20 &&
          $gameVariables.value(160 + eval(args[1]))[8] == 1
        ) {
          //下剤---途中排便なし　脱糞
          ...
          $gameVariables.value(160 + eval(args[1]))[2] == 30 &&
          $gameVariables.value(160 + eval(args[1]))[8] == 0
        ) {
          //複合---途中排便した場合は汚れない
        } else if (
      ...
      if ($gameVariables.value(160 + eval(args[1]))[17] == 1) {
        if ($gameVariables.value(100) == 5) {
          ...
          $gameVariables.value(100) == 11 ||
          $gameVariables.value(100) == 12
        ) {
          //オルガ アッチャラーの場合
