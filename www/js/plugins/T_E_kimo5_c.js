  ...
  Game_Interpreter.prototype.pluginCommand = function (command, args) {
    ...
    if (command === "SentakuNo") {
      ...
      if ($gameVariables.value(100) == 12) {
        ...
        if (!$gameSwitches.value(162)) {
          ...
          if (!$gameSwitches.value(163)) {
            $gameScreen.showPicture(
              41,
              x_name_b[$gameVariables.value(100)] + "_prof1",
              0,
              q1,
              q2,
              100,
            ...
            $gameScreen.showPicture(
              41,
              x_name_b[$gameVariables.value(100)] + "_prof3",
              0,
              q1,
              q2,
              100,
          ...
          $gameScreen.showPicture(
            41,
            x_name_b[$gameVariables.value(100)] + "_prof2",
            0,
            q1,
            q2,
            100,
        ...
        $gameScreen.showPicture(
          41,
          x_name_b[$gameVariables.value(100)] + "_prof",
          0,
          q1,
          q2,
          100,
