...
Imported["SumRndmDde Picture Choices"] = 1.0;
...
(function (_) {
  ...
  Window_Message.prototype.isAnySubWindowActive = function () {
    return (
      ...
      this._pictureChoiceWindow.active
    );
  };
  ...
  Window_PictureChoiceList.prototype = Object.create(
  ...
  var _Window_PictureChoiceList_initialize =
    Window_PictureChoiceList.prototype.initialize;
  ...
  Window_PictureChoiceList.prototype.updatePlacement = function () {
    ...
    if (!this._messageWindow.isClosed()) {
      if (this._messageWindow.y > Graphics.boxHeight / 2)
        this.y -= this._messageWindow.height / 2;
      else if (this._messageWindow.y <= 0)
        this.y += this._messageWindow.height / 2;
    }
  };

  var _Window_PictureChoiceList_start =
    Window_PictureChoiceList.prototype.start;
  ...
  Window_PictureChoiceList.prototype.contentsHeight =
    Window_Base.prototype.contentsHeight;

  var _Window_PictureChoiceList_drawItem =
    Window_PictureChoiceList.prototype.drawItem;
  Window_PictureChoiceList.prototype.drawItem = function (index) {
    var name = this.commandName(index);
    var rect = this.itemRectForText(index);
    if (name.match(/\\picture\[(.*)\]/i)) {
      if (this._spriteChoices[index])
        this.removeChild(this._spriteChoices[index]);
  ...
  var _Window_PictureChoiceList_update =
    Window_PictureChoiceList.prototype.update;
