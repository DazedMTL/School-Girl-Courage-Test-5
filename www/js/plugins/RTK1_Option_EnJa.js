...
(function (_global) {
  ...
  if (RTK.VERSION_NO < 1.13) {
    throw new Error(
      "This plugin requires version 1.13 or later of RTK1_Core plugin. the current version looks " +
        RTK.VERSION_NO +
        "."
    );
  }
  ...
  Window_Options.prototype.makeCommandList = function () {
    ...
    if (M._hide == 0) {
      this.addCommand(
        ConfigManager.langSelect ? "言語" : "Language",
        "langSelect"
      );
    }
  };
  ...
  M.writeTranslationBase = function () {
    var ret = {
      actors: $dataActors
        .map(function (o) {
          return o ? [o.name, o.nickname, o.profile] : null;
        })
        .splice(1),
      classes: $dataClasses
        .map(function (o) {
      ...
      items: $dataItems
        .map(function (o) {
          return o ? [o.name, o.description] : null;
        })
        .splice(1),
      weapons: $dataWeapons
        .map(function (o) {
      ...
      states: $dataStates
        ...
        .splice(1),
      t_weapons: $dataSystem.weaponTypes
        .map(function (o) {
          return o;
        })
        .splice(1),
      t_armors: $dataSystem.armorTypes
        .map(function (o) {
          return o;
        })
        .splice(1),
      t_equips: $dataSystem.equipTypes
        .map(function (o) {
          return o;
        })
        .splice(1),
      t_skills: $dataSystem.skillTypes
        .map(function (o) {
          return o;
        })
        .splice(1),
      t_elements: $dataSystem.elements
        .map(function (o) {
          return o;
        })
        .splice(1),
