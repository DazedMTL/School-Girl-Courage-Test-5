  ...
  Game_Interpreter.prototype.pluginCommand = function (command, args) {
    ...
    if (command === "kikan_odo_kaiso") {
      ...
      if ($gameVariables.value(246) == 6 || $gameVariables.value(246) == 7) {
        //渡辺登樹子、桃乃夢の場合
        if (
          $gameVariables.value(260)[0] >= 1 &&
          $gameVariables.value(260)[0] <= 4
        ) {
      ...
      if ($gameVariables.value(246) == 10) {
        ...
        if (
          $gameVariables.value(260)[0] == 1 &&
          ($gameVariables.value(260)[1] == 1 ||
            $gameVariables.value(260)[1] == 2)
        ) {
          $gameVariables.setValue(69, 1);
        }
      }
      ...
      if ($gameVariables.value(260)[2] == 0) {
        ...
        if (
          ...
          if (
            ...
            $gameVariables.setValue(73, 1); //DLC4 ----------------------------------------
        ...
        $gameVariables.value(260)[3] == 0 &&
        $gameVariables.value(260)[2] >= 1
      ) {
        //パンティで失禁の場合
      ...
      if (
        ...
        $gameVariables.setValue(
          191,
          "sire" + $gameVariables.value(246) + "_b11_2"
        );
      } else {
        $gameVariables.setValue(
          191,
          "sire" + $gameVariables.value(246) + "_b11_1"
        );
      }
      ...
      if (
        ...
        ($gameVariables.value(260)[1] == 1 ||
          $gameVariables.value(260)[1] == 2 ||
          $gameVariables.value(260)[1] == 4 ||
          $gameVariables.value(260)[1] == 5)
      ) {
        //回想　失神帰還-座薬効果あり　の場合
      } else {
        //通常回想
        ...
        if (
          $gameVariables.value(260)[0] == 1 ||
          $gameVariables.value(260)[0] == "b" ||
          $gameVariables.value(260)[0] == "c"
        ) {
          ...
          if ($gameVariables.value(260)[3] == 0) {
            ...
            if ($gameVariables.value(260)[2] == 0) {
              ...
              //DLC4 ----------------------------------------
              if (
                $gameVariables.value(246) >= 10 &&
                $gameVariables.value(246) <= 13
              ) {
                //DLC4の場合
          ...
          $gameVariables.value(260)[0] == 2 ||
          $gameVariables.value(260)[0] == "d"
        ) {
          ...
          if ($gameVariables.value(260)[0] == "d") {
            if (
              $gameVariables.value(246) == 1 ||
              ($gameVariables.value(246) >= 3 && $gameVariables.value(246) <= 6)
            ) {
              //（ブラ+ブリーフ）
          ...
          $gameVariables.value(260)[0] == 3 ||
          $gameVariables.value(260)[0] == "e"
        ) {
          //------- 制服上+タオル ブラ+タオル　の場合 -------
          ...
          if (
            $gameVariables.value(246) == 2 ||
            $gameVariables.value(246) == 4
          ) {
            //山田美兎、佐藤莉伊南の場合
          ...
          $gameVariables.value(260)[0] == 4 ||
          $gameVariables.value(260)[0] == "f" ||
          $gameVariables.value(260)[0] == "a"
        ) {
    ...
    if (command === "k_chara_name") {
      ...
      if ($gameVariables.value(220 + $gameVariables.value(81))[2] == 1) {
        ...
        if (
          $gameVariables.value(220 + $gameVariables.value(81))[3] == 1 ||
          $gameVariables.value(220 + $gameVariables.value(81))[3] == 2
        ) {
          //レイプのみ
          switch ($gameVariables.value(100)) {
            case 1:
        ...
        if (
          $gameVariables.value(220 + $gameVariables.value(81))[3] == 3 ||
          $gameVariables.value(220 + $gameVariables.value(81))[3] == 4 ||
          $gameVariables.value(220 + $gameVariables.value(81))[3] == 5
        ) {
          //座薬効果（レイプ含む）
    ...
    if (command === "kikan_odo") {
      ...
      if ($gameVariables.value(220 + $gameVariables.value(81))[0] > 10) {
        ...
        $gameVariables.setValue(
          71,
          $gameVariables.value(220 + $gameVariables.value(81))[0] - 10
        );
      } else {
        $gameVariables.setValue(
          71,
          $gameVariables.value(220 + $gameVariables.value(81))[0]
        );
      }
      //口--------------------------------------------------
      $gameVariables.setValue(
        72,
        $gameVariables.value(220 + $gameVariables.value(81))[1]
      );
      ...
      if ($gameVariables.value(246) == 6 || $gameVariables.value(246) == 7) {
        ...
        if (
          $gameVariables.value(220 + $gameVariables.value(81))[5] >= 1 &&
          $gameVariables.value(220 + $gameVariables.value(81))[5] <= 4
        ) {
          $gameVariables.setValue(69, 2);
        } else {
          $gameVariables.setValue(69, 1);
      ...
      if (
        $gameVariables.value(160 + $gameVariables.value(245))[0] == 0 &&
        $gameVariables.value(160 + $gameVariables.value(245))[7] == 1
      ) {
        //パンティで失禁の場合
      ...
      if (
        ...
        if ($gameVariables.value(220 + $gameVariables.value(81))[4] == 1) {
          //パンティ　濡れているか？
          if (
            $gameVariables.value(150 + $gameVariables.value(245))[6] == 11 ||
            $gameVariables.value(150 + $gameVariables.value(245))[6] == 111
          ) {
            $gameVariables.setValue(76, 11);
            ...
            if (
              ...
              if (
                $gameVariables.value(160 + $gameVariables.value(245))[7] == 1 &&
                $gameVariables.value(160 + $gameVariables.value(245))[8] == 0
              ) {
                $gameVariables.setValue(76, 12);
              } else if (
                $gameVariables.value(160 + $gameVariables.value(245))[7] == 0 &&
                $gameVariables.value(160 + $gameVariables.value(245))[8] == 1
              ) {
            ...
            if (
              ...
              if ($gameSwitches.value(162)) {
                //アッチャラーの場合
                if (
                  $gameVariables.value(160 + $gameVariables.value(245))[7] ==
                    1 &&
                  $gameVariables.value(160 + $gameVariables.value(245))[8] == 0
                ) {
                  $gameVariables.setValue(76, 122);
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[4] == 2
        ) {
          //オムツ　濡れているか？
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[4] == 3
        ) {
          //ブリーフ
          $gameVariables.setValue(76, 3);
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[4] == 4
        ) {
          //タオル
          $gameVariables.setValue(76, 4);
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[4] == 5
        ) {
          //ビキニ
      ...
      if (
        ...
        if (
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[5] == 5
        ) {
          //ランニングシャツ
          $gameVariables.setValue(70, 22);
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[5] == 6
        ) {
          //エプロン
          if (
            $gameVariables.value(246) == 2 ||
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[5] == 7
        ) {
          //スク水
          $gameVariables.setValue(70, 42);
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[5] == 8
        ) {
          //段ボール
          $gameVariables.setValue(70, 52);
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[5] == 9
        ) {
          //新聞
          $gameVariables.setValue(70, 62);
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[5] == "a"
        ) {
          //ビキニ
          $gameVariables.setValue(70, 10);
        }
        ...
        if ($gameVariables.value(220 + $gameVariables.value(81))[5] == 1) {
          ...
          if ($gameVariables.value(160 + $gameVariables.value(245))[17] == 1) {
            ...
            if (
              ...
              if (
                ...
                //モリー、オルガの場合
                if (
                  $gameVariables.value(160 + $gameVariables.value(245))[0] ==
                    0 &&
                  $gameVariables.value(160 + $gameVariables.value(245))[8] == 1
                ) {
                  $gameVariables.setValue(70, 113);
          ...
          $gameVariables.value(220 + $gameVariables.value(81))[5] >= 2 &&
          $gameVariables.value(220 + $gameVariables.value(81))[5] <= 4
        ) {
          //制服上+ブリーフ、制服上+タオル、制服上+ビキニパンツ　用の制服　上部分
      ...
      if (
        $gameVariables.value(220 + $gameVariables.value(81))[4] >= 1 &&
        $gameVariables.value(220 + $gameVariables.value(81))[4] <= 5 &&
        $gameVariables.value(220 + $gameVariables.value(81))[5] == 0
      ) {
        //下着
        if ($gameVariables.value(160 + $gameVariables.value(245))[17] == 1) {
          //上が濡れている場合
        ...
        if (
          ...
          if ($gameSwitches.value(162)) {
            //アッチャラーの場合
            if (
              $gameVariables.value(160 + $gameVariables.value(245))[17] == 1
            ) {
              //上が濡れている場合
              $gameVariables.setValue(68, 1112);
            } else {
