    ...
    if (command === "tasseido") {
      if (args[0] == "all") {
        if ($gameSwitches.value(161)) {
          ...
          //DLC4 追加シーン
          if ($gameVariables.value(580) == 99) {
            x_all = 14 * ($gameVariables.value(252) + 1); //回想のパターン数 * 人数　全
          } else {
      ...
      if ($gameVariables.value(189) == 0) {
        ...
        for (x_count = 1; x_count <= 6; x_count++) {
          ...
          if ($gameVariables.value(280 + x_count) == 3) {
            ...
            $gameVariables.value(280 + x_count) == 1 ||
            $gameVariables.value(280 + x_count) == 2
          ) {
            x_no = x_no + 1;
          }
          //フェラ
          if ($gameVariables.value(300 + x_count) == 3) {
            ...
            $gameVariables.value(300 + x_count) == 1 ||
            $gameVariables.value(300 + x_count) == 2
          ) {
            x_no = x_no + 1;
          }
          //セックス
          if ($gameVariables.value(320 + x_count) == 3) {
            ...
            $gameVariables.value(320 + x_count) == 1 ||
            $gameVariables.value(320 + x_count) == 2
          ) {
            x_no = x_no + 1;
          }
          //もよおし
          if ($gameVariables.value(340 + x_count) == 3) {
            ...
            $gameVariables.value(340 + x_count) == 1 ||
            $gameVariables.value(340 + x_count) == 2
          ) {
            x_no = x_no + 1;
          }
          //座薬
          ...
          //足コキ
          if ($gameVariables.value(560 + x_count) == 1) {
            x_no = x_no + 1;
          }
          //失神帰還使用可能の場合、シーン+5  DLC2
          if ($gameSwitches.value(52)) {
        ...
        if ($gameSwitches.value(50)) {
          ...
          if ($gameVariables.value(287) == 3) {
            ...
            $gameVariables.value(287) == 1 ||
            $gameVariables.value(287) == 2
          ) {
            x_no = x_no + 1;
          }
          //フェラ
          if ($gameVariables.value(307) == 3) {
            ...
            $gameVariables.value(307) == 1 ||
            $gameVariables.value(307) == 2
          ) {
            x_no = x_no + 1;
          }
          //セックス
          if ($gameVariables.value(327) == 3) {
            ...
            $gameVariables.value(327) == 1 ||
            $gameVariables.value(327) == 2
          ) {
            x_no = x_no + 1;
          }
          //もよおし
          if ($gameVariables.value(347) == 3) {
            ...
            $gameVariables.value(347) == 1 ||
            $gameVariables.value(347) == 2
          ) {
            x_no = x_no + 1;
          }
          //座薬
        ...
        if ($gameSwitches.value(94)) {
          ...
          if ($gameVariables.value(288) == 3) {
            ...
            $gameVariables.value(288) == 1 ||
            $gameVariables.value(288) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(289) == 3) {
            ...
            $gameVariables.value(289) == 1 ||
            $gameVariables.value(289) == 2
          ) {
            x_no = x_no + 1;
          }
          //フェラ
          if ($gameVariables.value(308) == 3) {
            ...
            $gameVariables.value(308) == 1 ||
            $gameVariables.value(308) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(309) == 3) {
            ...
            $gameVariables.value(309) == 1 ||
            $gameVariables.value(309) == 2
          ) {
            x_no = x_no + 1;
          }
          //セックス
          if ($gameVariables.value(328) == 3) {
            ...
            $gameVariables.value(328) == 1 ||
            $gameVariables.value(328) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(329) == 3) {
            ...
            $gameVariables.value(329) == 1 ||
            $gameVariables.value(329) == 2
          ) {
            x_no = x_no + 1;
          }
          //もよおし
          if ($gameVariables.value(348) == 3) {
            ...
            $gameVariables.value(348) == 1 ||
            $gameVariables.value(348) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(349) == 3) {
            ...
            $gameVariables.value(349) == 1 ||
            $gameVariables.value(349) == 2
          ) {
            x_no = x_no + 1;
          }
          //座薬
          ...
          //足コキ
          if ($gameVariables.value(568) == 1) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(569) == 1) {
            x_no = x_no + 1;
          }
          // +DLC2
          if ($gameSwitches.value(52)) {
        ...
        if ($gameSwitches.value(161)) {
          ...
          if ($gameVariables.value(290) == 3) {
            ...
            $gameVariables.value(290) == 1 ||
            $gameVariables.value(290) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(291) == 3) {
            ...
            $gameVariables.value(291) == 1 ||
            $gameVariables.value(291) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(292) == 3) {
            ...
            $gameVariables.value(292) == 1 ||
            $gameVariables.value(292) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(293) == 3) {
            ...
            $gameVariables.value(293) == 1 ||
            $gameVariables.value(293) == 2
          ) {
            x_no = x_no + 1;
          }
          //フェラ
          if ($gameVariables.value(310) == 3) {
            ...
            $gameVariables.value(310) == 1 ||
            $gameVariables.value(310) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(311) == 3) {
            ...
            $gameVariables.value(311) == 1 ||
            $gameVariables.value(311) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(312) == 3) {
            ...
            $gameVariables.value(312) == 1 ||
            $gameVariables.value(312) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(313) == 3) {
            ...
            $gameVariables.value(313) == 1 ||
            $gameVariables.value(313) == 2
          ) {
            x_no = x_no + 1;
          }
          //セックス
          if ($gameVariables.value(330) == 3) {
            ...
            $gameVariables.value(330) == 1 ||
            $gameVariables.value(330) == 2
          ) {
            x_no = x_no + 1;
          }
          ...
          if ($gameVariables.value(332) == 3) {
            ...
            $gameVariables.value(332) == 1 ||
            $gameVariables.value(332) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(333) == 3) {
            ...
            $gameVariables.value(333) == 1 ||
            $gameVariables.value(333) == 2
          ) {
            x_no = x_no + 1;
          }
          //もよおし
          if ($gameVariables.value(350) == 3) {
            ...
            $gameVariables.value(350) == 1 ||
            $gameVariables.value(350) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(351) == 3) {
            ...
            $gameVariables.value(351) == 1 ||
            $gameVariables.value(351) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(352) == 3) {
            ...
            $gameVariables.value(352) == 1 ||
            $gameVariables.value(352) == 2
          ) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(353) == 3) {
            ...
            $gameVariables.value(353) == 1 ||
            $gameVariables.value(353) == 2
          ) {
            x_no = x_no + 1;
          }
          //座薬
          ...
          //足コキ
          if ($gameVariables.value(570) == 1) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(571) == 1) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(572) == 1) {
            x_no = x_no + 1;
          }
          if ($gameVariables.value(573) == 1) {
            x_no = x_no + 1;
          }
        ...
        if ($gameVariables.value(280 + $gameVariables.value(189)) == 3) {
          ...
          $gameVariables.value(280 + $gameVariables.value(189)) == 1 ||
          $gameVariables.value(280 + $gameVariables.value(189)) == 2
        ) {
          x_no = x_no + 1;
        }
        //フェラ
        if ($gameVariables.value(300 + $gameVariables.value(189)) == 3) {
          ...
          $gameVariables.value(300 + $gameVariables.value(189)) == 1 ||
          $gameVariables.value(300 + $gameVariables.value(189)) == 2
        ) {
          x_no = x_no + 1;
        }
        //セックス
        if ($gameVariables.value(320 + $gameVariables.value(189)) == 3) {
          ...
          $gameVariables.value(320 + $gameVariables.value(189)) == 1 ||
          $gameVariables.value(320 + $gameVariables.value(189)) == 2
        ) {
          x_no = x_no + 1;
        }
        //もよおし
        if ($gameVariables.value(340 + $gameVariables.value(189)) == 3) {
          ...
          $gameVariables.value(340 + $gameVariables.value(189)) == 1 ||
          $gameVariables.value(340 + $gameVariables.value(189)) == 2
        ) {
          x_no = x_no + 1;
        }
        //座薬
        ...
        //足コキ
        if ($gameVariables.value(560 + $gameVariables.value(189)) == 1) {
          x_no = x_no + 1;
        }
